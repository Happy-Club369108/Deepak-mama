...
const Home = () => {
    ...
    return (
        <Box sx={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
                    ...
                    <Toolbar sx={{ justifyContent: 'space-between', py: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Box>
                                ...
                                <Typography variant="caption" sx={{ color: '#64748b' }}>Luotettava henkilöstöpalveluyritys Suomessa ja Euroopassa</Typography>
                            </Box>
                        </Box>
            ...
            <Box sx={{
                position: 'relative',
                backgroundImage: 'ur[](https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=1920&auto=format&fit=crop&q=80)',
            ...
            <Container sx={{ py: 8 }}>
                ...
                <Paper sx={{
                    ...
                    <Typography variant="h4" gutterBottom sx={{ fontWeight: 800 }}>Valmis uuteen työuraan Suomessa?</Typography>
                    <Typography variant="h6" sx={{ mb: 3, opacity: 0.9 }}>Hae nyt mielenkiintoisia työpaikkoja Suomesta ja Euroopasta!</Typography>
                ...
                {/* Jobs Section */}
                <Typography variant="h4" gutterBottom sx={{ color: '#1e293b', fontWeight: 900, mb: 4, textAlign: 'center' }}>
                ...
                <Grid container spacing={4} sx={{ mb: 8 }}>
                    <Grid item xs={12} md={6}>
                        <Card sx={{ height: '100%', borderRadius: 3, overflow: 'hidden' }}>
                            ...
                            <CardContent sx={{ p: 4 }}>
                                ...
                                <Stack spacing={2}>
                                    <Link href="mailto:info@jwfulfilments.com" sx={{ display: 'flex', alignItems: 'center', color: '#3b82f6', textDecoration: 'none' }}>
                                        <Email sx={{ mr: 1 }} /> info@jwfulfilments.com
                                    </Link>
                                    <Link href="tel:+358401234567" sx={{ display: 'flex', alignItems: 'center', color: '#3b82f6', textDecoration: 'none' }}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Card sx={{
                            ...
                            borderRadius: 3,
                            bgcolor: '#f0f9ff',
                            backgroundImage: 'ur[](https://images.unsplash.com/photo-1551836026-d5c2c0b4d8e9?w=600&auto=format&fit=crop&q=80)',
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                            position: 'relative'
                        }}>
                            ...
                            <CardContent sx={{ p: 4, position: 'relative', zIndex: 1 }}>
                                ...
                                <Typography sx={{ mb: 3 }}>Lähetä tietosi – rekrytointitiimimme ottaa sinuun yhteyttä 24 tunnin sisällä.</Typography>
                                <Button
                                    variant="contained"
                                    fullWidth
                                    size="large"
                    ...
                    <Grid container spacing={4}>
                        <Grid item xs={12} md={4}>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                ...
                                <Box>
                                    <Typography variant="h6" sx={{ fontWeight: 800 }}>JW Fulfilments OY</Typography>
                                    <Typography variant="body2" sx={{ opacity: 0.8 }}>Henkilöstöratkaisut Suomessa ja Euroopassa</Typography>
                                </Box>
                            </Box>
                        ...
                        <Grid item xs={12} md={4}>
                            ...
                            <Stack spacing={1}>
                                <Link href="#" color="inherit" sx={{ opacity: 0.8, '&:hover': { opacity: 1 } }}>Yrityksille</Link>
            ...
            <Dialog open={openForm} onClose={() => !loading && setOpenForm(false)} maxWidth="sm" fullWidth>
                <DialogTitle sx={{ bgcolor: '#1e40af', color: 'white' }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Typography variant="h6" sx={{ fontWeight: 700 }}>Työhakemus</Typography>
                ...
                <DialogContent sx={{ p: 3 }}>
                    <form onSubmit={handleSubmit} style={{ marginTop: '20px', marginBottom: '20px' }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <TextField fullWidth required label="Sähköposti" name="email" type="email" value={formData.email} onChange={handleFormChange} disabled={loading} />
                            </Grid>
                            <Grid item xs={12}>
                            ...
                            <Grid item xs={12} md={6}>
                                <FormControl fullWidth required>
                                    ...
                                    <Select name="position" value={formData.position} onChange={handleFormChange} label="Haettava tehtävä" disabled={loading}>
                            ...
                            <Grid item xs={12} md={6}>
                                <FormControl fullWidth required>
                                    ...
                                    <Select name="experience" value={formData.experience} onChange={handleFormChange} label="Kokemus" disabled={loading}>
                            ...
                            <Grid item xs={12}>
                                <TextField fullWidth multiline rows={3} label="Lisätiedot / viesti" name="message" value={formData.message} onChange={handleFormChange} disabled={loading} />
                            </Grid>
                        </Grid>
